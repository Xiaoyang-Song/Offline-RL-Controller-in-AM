...
# SURROGATE="surrogate_model_latent/runs/20260601_162903/latent_best.pt"
SURROGATE="surrogate_model_latent/runs/20260602_125822/latent_best.pt"
...
UNCERTAINTY_PENALTY_WEIGHT=0.1   # λ — only used when mode=penalty
